              ...
              <div className="absolute right-0 top-full mt-2 w-64 rounded-2xl z-50 py-2 overflow-hidden bg-[var(--bg-0)] border border-[var(--border-color)] shadow-xl">
                ...
                <div className="px-5 py-3 border-b border-[var(--border-color)]">
                  ...
                  <p className="text-[10px] text-[var(--text-muted)] mt-1">
                    Unlimited paper trading · All tools included
                  </p>
                </div>

                <div className="py-1">
                  <Link href="/portfolio" onClick={() => setMenuOpen(false)}
                    className="w-full flex items-center gap-3 px-5 py-3 text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-2)] transition-colors">
