...
export function AdminTopbar({ title }: { title?: string }) {
  ...
  return (
    <header className="h-14 sm:h-16 flex items-center justify-between px-3 sm:px-6 border-b shrink-0"
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <Link href="/dashboard">
          <motion.div
            whileHover={{ x: -2 }}
            className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 rounded-lg border text-xs font-medium cursor-pointer transition-colors hover:bg-white/5"
        ...
        <h1 className="text-sm sm:text-lg font-bold truncate" style={{ color: 'var(--admin-text)' }}>
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {/* Last tick time */}
        <div className="hidden md:flex items-center gap-1.5 text-xs" style={{ color: 'var(--admin-muted)' }}>
        ...
        {user && (
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden lg:block text-xs" style={{ color: 'var(--admin-subtext)' }}>
            ...
            <motion.button
              ...
              className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 rounded-lg border text-xs font-medium cursor-pointer transition-colors hover:bg-red-500/10"
